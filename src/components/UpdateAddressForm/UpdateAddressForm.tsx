...
import { AddressPatch } from '@/src/model/Address';
...
interface Props {
  form: UseFormReturn<AddressPatch>;
  alertProps?: ComponentProps<typeof Alert>;
  onSubmit: SubmitHandler<AddressPatch>;
}

const UpdateAddressForm: FC<Props> = ({
  form,
  alertProps,
      ...
      >
        ...
        >
          {form.formState.isSubmitting ? (
            ...
            t('update-address-modal-confirm-button-text')
          )}
        </button>
      </form>
